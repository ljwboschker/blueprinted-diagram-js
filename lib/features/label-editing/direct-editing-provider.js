...
export default function DirectEditingProvider(
  ...
  this.getEmbeddedTextEditor = () => new EmbeddedTextEditor(this._canvas, this._eventBus, this._modeling);
...
DirectEditingProvider.prototype.update = function activate(element, newText, oldText) {
  const editor = element.type === 'label'
    ? this.getLabelEditor()
    : this.getEmbeddedTextEditor();
